...
if (integrations.ads.provider === "adsterra") {
  privacyIntegrationParagraphs.push(
    "Adsterra advertising is enabled (responsive banners, native placements, and social bar). Adsterra may process technical request information and applies its own privacy policy.",
  );
}
